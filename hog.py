...
def same_len(score1, score2):
    return digit_counter(score1) == digit_counter(score2)

def first_digit(score):
    # """Return the first digit of a player's score"""
    if digit_counter(score) == 1:
        return 0
    else:
        return score // (10 ** (digit_counter(score) - 1))
    
def second_digit(score):
    # """Return the second digit of a player's score"""
    k = 0
    while k < digit_counter(score) - 2:
        score = score // 10
        k += 1
    score = score - first_digit(score) * (10 ** ((digit_counter(score) - 1)))
    return score // (10 ** (digit_counter(score) - 1)) 
...
def more_boar(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    return first_digit(player_score) < first_digit(opponent_score) and second_digit(player_score) < second_digit(opponent_score)
    # END PROBLEM 4
